...
public class Main {
    public static void main(String[] args) {
        ...
        //     );
        // maintenanceNonRecurrent.addItem(new Item("Mano de obra", 30.0));
        ...
        // maintenanceTimeOnly.addItem(new Item("Revisión de frenos", 40.0));
        // maintenanceTimeOnly.addItem(new Item("Alineación", 20.0));
        ...
        // maintenanceKmOnly.addItem(new Item("Inspección visual", 25.0));
        ...
        // maintenanceBoth.addItem(new Item("Cambio de líquido de frenos", 70.0));
        // maintenanceBoth.addItem(new Item("Cambio de filtro", 35.0));
        // maintenanceBoth.addItem(new Item("Mano de obra", 40.0));
