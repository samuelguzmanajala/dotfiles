...
import tv.fleet.apps.manager.backend.ManagerApplication;
import tv.fleet.shared.infrastructure.cli.ConsoleCommand;
...
public class starter {
	...
	private static HashMap<String, Class<?>> applications() {
		...
		applications.put("manager_backend", ManagerApplication.class);
	...
	private static HashMap<String, HashMap<String, Class<?>>> commands() {
		...
		commands.put("manager_backend", ManagerApplication.commands());
